    ...
    <section id="privacyTerms">
        ...
        <br>
            ...
            <p>O nosso site pode ter links para sites externos que não são operados por nós. Esteja ciente de que não
                ...
                respectivas <a href='./privacyterms.html' target='_BLANK'>políticas de privacidade</a>. </p>
            ...
            <ul>
                ...
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do , de seus fornecedores
                    ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de
